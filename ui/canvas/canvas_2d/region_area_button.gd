...
# warning-ignore:return_value_discarded
	connect("top_moved", parent, "_on_top_limit_changed_by")
# warning-ignore:return_value_discarded
	connect("bottom_moved", parent, "_on_bottom_limit_changed_by")
# warning-ignore:return_value_discarded
	connect("right_moved", parent, "_on_right_limit_changed_by")
# warning-ignore:return_value_discarded
	connect("left_moved", parent, "_on_left_limit_changed_by")
...
func _on_button_down():
	...
	if viewport_container.get_global_rect().has_point(viewport_container.get_global_mouse_position()):
		layer.activate_transfrom_button(self) # this is to set the active_button in controller
...
func snap(grid_size: int):
	...
	if top:
		emit_signal("top_moved", -snap_amount_y)
	elif bottom:
		emit_signal("bottom_moved", -snap_amount_y)

	if right:
		emit_signal("right_moved", -snap_amount_x)
	elif left:
		emit_signal("left_moved", -snap_amount_x)
