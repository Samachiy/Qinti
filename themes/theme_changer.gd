...
onready var data: Dictionary = {
	BLUE_LIGHT: ThemeData.new(
			...
			_compose_dict(Consts.THEME_LIGHT_TYPE, Consts.THEME_BLUE_LIGHT_STYLE),
			false,
			BLUE_DARK,
	...
	BLUE_DARK: ThemeData.new(
			...
			_compose_dict(Consts.THEME_DARK_TYPE, Consts.THEME_BLUE_DARK_STYLE),
			true,
			BLUE_LIGHT,
	...
	ORANGE_LIGHT: ThemeData.new(
			...
			_compose_dict(Consts.THEME_LIGHT_TYPE, Consts.THEME_ORANGE_LIGHT_STYLE),
			false,
			ORANGE_DARK,
	...
	ORANGE_DARK: ThemeData.new(
			...
			_compose_dict(Consts.THEME_DARK_TYPE, Consts.THEME_ORANGE_DARK_STYLE),
			true,
			ORANGE_LIGHT,
	...
	PINK_LIGHT: ThemeData.new(
			...
			_compose_dict(Consts.THEME_LIGHT_TYPE, Consts.THEME_PINK_LIGHT_STYLE),
			false,
			PINK_DARK,
	...
	PINK_DARK: ThemeData.new(
			...
			_compose_dict(Consts.THEME_DARK_TYPE, Consts.THEME_PINK_DARK_STYLE),
			true,
			PINK_LIGHT,
	...
	RED_LIGHT: ThemeData.new(
			...
			_compose_dict(Consts.THEME_LIGHT_TYPE, Consts.THEME_RED_LIGHT_STYLE),
			false,
			RED_DARK,
	...
	RED_DARK: ThemeData.new(
			...
			_compose_dict(Consts.THEME_DARK_TYPE, Consts.THEME_RED_DARK_STYLE),
			true,
			RED_LIGHT,
